...
cfg.TRAIN.PRETRAINED_RESNET50_PATH = "/home/supermicro-2/AVS/AudioClip-AVS/avss/model/resnet50-19c8e357.pth"
cfg.TRAIN.PRETRAINED_PVTV2_PATH = "/home/supermicro-2/AVS/AudioClip-AVS/avss/model/pvt_v2_b5.pth"
...
cfg.DATA.META_CSV_PATH = "/home/supermicro-2/AVS/metadata.csv" #! notice: you need to change the path
cfg.DATA.LABEL_IDX_PATH = "/home/supermicro-2/AVS/label2idx.json" #! notice: you need to change the path

cfg.DATA.DIR_BASE = "/home/supermicro-2/AVS" #! notice: you need to change the path
